...
namespace Api.Juros.Calculo.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ITaxaJurosExternalClient, TaxaJurosExternalClient>();

            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Cálculo de Juros", Version = "v1" });
